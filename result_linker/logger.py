...
logger = logging.getLogger("result_linker")
...
fh = logging.handlers.RotatingFileHandler(
    'result_linker.log', maxBytes=1024*1024, backupCount=10)
...
def install_logger(application,logger_name = "result_linker"):
    ...
    request_fh = logging.handlers.RotatingFileHandler(
        '{}_requests.log'.format(logger_name), maxBytes=1024*1024, backupCount=10)
